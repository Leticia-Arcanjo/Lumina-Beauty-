          ...
          <form onSubmit={handleSave} className="w-full max-w-lg rounded-2xl bg-card p-6 shadow-elegant">
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                <Field label="Preço (R$)"><input type="number" step="0.01" required value={editing.price === 0 ? "" : editing.price}
onChange={(e) =>
  setEditing({
    ...editing,
          ...
          <form onSubmit={saveCoupon} className="w-full max-w-md rounded-2xl bg-card p-6 shadow-elegant">
            ...
            <div className="space-y-3">
              ...
              <Field label="Válido a partir de">
                <input
                  type="datetime-local"
                  value={editingCoupon.starts_at?.slice(0, 16) || ""}
                  onChange={(e) =>
  setEditingCoupon({
    ...editingCoupon,
    starts_at: e.target.value,
              ...
              <Field label="Válido até (opcional)">
                <input
                  type="datetime-local"
                  value={editingCoupon.ends_at?.slice(0, 16) || ""}
                  onChange={(e) =>
  setEditingCoupon({
    ...editingCoupon,
