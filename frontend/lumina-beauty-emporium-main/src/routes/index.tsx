...
<Link
  to="/"
  search={{ cat: "Beleza" } as never}
  hash="produtos"
  className="inline-flex items-center gap-2 rounded-full border border-foreground/15 bg-background/80 px-7 py-3.5 text-sm font-semibold backdrop-blur transition-all hover:border-primary/40"
>
  Ver Beleza
</Link>
            </div>
