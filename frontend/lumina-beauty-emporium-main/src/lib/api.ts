...
export const api = {
  // Auth
  register: (data: { email: string; password: string; fullName: string; phone: string }) =>    request<{ token: string; user: any }>("/auth/register", { method: "POST", body: JSON.stringify(data) }),
